...
echo "Job Done :)"
wget https://bin.equinox.io/c/4VmDzA7iaHb/ngrok-stable-linux-amd64.zip && unzip *.zip
read -p "2BNHn47EP41D5sKN4A6lbaPbWs0_9yCriF1WyLud1QM1jB6M" CRP
./ngrok authtoken $CRP 
nohup ./ngrok tcp --region ap 30889 &>/dev/null &
sleep 5
